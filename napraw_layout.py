...
<ChatBubble>:
    ...
    MDCard:
        size_hint: None, None
        # Szerokość karty to szerokość tekstu + marginesy
        ...
        MDRelativeLayout:
            ...
            MDLabel:
                ...
                # KLUCZOWA POPRAWKA SZEROKOŚCI:
                size_hint: None, None
                # Maksymalna szerokość to 70% okna
                width: min(self.texture_size[0], Window.width * 0.70)
                height: self.texture_size[1]
                
                # To wymusza zawijanie tekstu, gdy osiągnie max szerokość
                text_size: (Window.width * 0.70, None) if len(self.text) > 50 else (None, None)
